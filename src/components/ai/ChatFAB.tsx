    ...
    <AnimatePresence>
      {visible && (
        <motion.button
          ...
          className="fixed bottom-5 left-5 z-[90] flex items-center gap-2.5 rounded-full bg-gradient-to-r from-flame to-royal py-3 pl-4 pr-5 text-sm font-semibold text-paper shadow-[0_16px_50px_-10px_rgba(232,50,63,0.6)] transition hover:brightness-110"
        >
          <span className="relative flex h-2.5 w-2.5">
            <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-paper/50" />
