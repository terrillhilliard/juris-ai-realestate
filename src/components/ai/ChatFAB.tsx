    ...
    <AnimatePresence>
      {visible && (
        <motion.button
          ...
          className="fixed bottom-5 right-5 z-[90] flex items-center gap-2.5 rounded-full bg-paper py-3 pl-4 pr-5 text-sm font-semibold text-ink shadow-[0_16px_50px_-12px_rgba(255,255,255,0.45)] transition hover:bg-white"
        >
